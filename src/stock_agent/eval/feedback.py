...
async def calculate_scores(
    ...
    *,
    ...
    with track_eval_run():
        ...
        # citation-level：以最终回答实际引用的股票为准。pool 纯度只代表检索召回，
        ...
        scores = {
            ...
            "profile_recall": profile_recall,          # 检索池纯度（参考）
            "profile_precision": profile_precision,    # 检索池纯度（参考）
